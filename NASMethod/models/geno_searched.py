from NASMethod.util.genotype import Genotype

'''
Search on Pascal voc
'''

GenotypeCrowdai = Genotype(down=[('max_pool', 0), ('max_pool', 1), ('dil_conv', 2), ('max_pool', 1), ('dil_conv', 2), ('max_pool', 1)], down_concat=range(2, 5), up=[('up_cweight', 1), ('dil_conv', 0), ('dil_conv', 0), ('dil_conv', 2), ('dil_conv', 0), ('dil_conv', 2)], up_concat=range(2, 5))
